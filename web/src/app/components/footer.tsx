  ...
  return (
    <div className="text-center flex flex-col items-center text-xs text-zinc-700 gap-1">
      ...
      <div className="flex items-center justify-center flex-wrap gap-x-4 gap-y-2 mt-2 text-zinc-400">
        <a className="hover:text-zinc-950" href="https://github.com/WGrape/aisearch">Home
        </a>
        <a
          className="hover:text-zinc-950"
          href="https://github.com/WGrape"
        >Github
        </a>
        <a
          className="hover:text-zinc-950"
          href="https://github.com/WGrape/wpylib"
        >
          Library wpylib
        </a>
        <a className="hover:text-zinc-950" href="https://wgrape.github.io/">
          Blog
        </a>
      </div>
    </div>
